...
CHAT_KEY_REQUESTS_PER_MINUTE: int = int(os.getenv("CHAT_KEY_REQUESTS_PER_MINUTE", "30"))
CHAT_KEY_DAILY_QUOTA: int = int(os.getenv("CHAT_KEY_DAILY_QUOTA", "2000"))
CHAT_KEY_DAILY_TOKEN_BUDGET: int = int(os.getenv("CHAT_KEY_DAILY_TOKEN_BUDGET", "300000"))
CHAT_MAX_ESTIMATED_INPUT_TOKENS: int = int(os.getenv("CHAT_MAX_ESTIMATED_INPUT_TOKENS", "2200"))
CHAT_MAX_SQL_COLUMNS: int = int(os.getenv("CHAT_MAX_SQL_COLUMNS", "20"))
CHAT_MAX_SQL_JOINS: int = int(os.getenv("CHAT_MAX_SQL_JOINS", "6"))
CHAT_MAX_SQL_CTES: int = int(os.getenv("CHAT_MAX_SQL_CTES", "3"))
CHAT_SQL_STATEMENT_TIMEOUT_MS: int = int(os.getenv("CHAT_SQL_STATEMENT_TIMEOUT_MS", "3500"))
CHAT_ANOMALY_WINDOW_SECONDS: int = int(os.getenv("CHAT_ANOMALY_WINDOW_SECONDS", "600"))
CHAT_MAX_OFFTOPIC_PER_WINDOW: int = int(os.getenv("CHAT_MAX_OFFTOPIC_PER_WINDOW", "8"))
CHAT_MAX_EXPENSIVE_PER_WINDOW: int = int(os.getenv("CHAT_MAX_EXPENSIVE_PER_WINDOW", "6"))
